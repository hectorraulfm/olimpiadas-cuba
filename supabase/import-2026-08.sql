...
with datos(anyo, orden, nombre, a1, a2, a3, a4, a5, a6, puntos, premio, puesto, nota) as (
  values
    ...
    (2021, 3, 'Aser Acosta Carrión', 0,1,0,3,5,0, 9, null, 66, ''),
    ...
    (2020, 3, 'Álvaro Luis González Brito', 6,2,0,6,5,0, 19, null, 45, ''),
    (2020, 4, 'Francisco Ernesto Préstamo Bernárdez', 6,3,0,0,3,0, 12, null, 63, ''),
    ...
    (2016, 4, '', 3,0,1,0,1,0, 5, null, 70, 'Nombre no recogido en la fuente'),
